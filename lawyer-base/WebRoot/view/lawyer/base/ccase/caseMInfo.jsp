...
<html>
  ...
  <body class="easyui-layout">
 	 ...
 	 <form id="searchForm">
        <p class="ui-fields">
			<label class="ui-label">案件来源:</label><input name="cpSrc" class="easyui-box ui-text" style="width:100px;">
			<label class="ui-label">案源人:</label><input name="cpSupply" class="easyui-box ui-text" style="width:100px;">
			<label class="ui-label">申请公证日期:</label><input name="cpApplyDate" class="easyui-box ui-text" style="width:100px;">
	    </p>
