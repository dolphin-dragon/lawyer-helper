     ...
     <div id="edit-win" class="easyui-dialog" title="会议室基本信息表" data-options="closed:true,iconCls:'icon-save',modal:true" style="width:500px;height:450px;">  
     	<form id="editForm" class="ui-form" method="post">  
     		 ...
     		 <div class="ui-edit hidden">
					...
					<div class="fitem">
						<label>会议室说明</label>
						<input name="mtrDescription" type="text" maxlength="1024" class="easyui-validatebox" data-options="" missingMessage="请填写会议室说明" style="margin: 0px; width: 300px;">
					</div>
  			</div>
     	</form>
  	 </div>
