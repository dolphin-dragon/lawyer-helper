...
<html>
  ...
  <body class="easyui-layout">
     ...
     <!-- Edit Win&Form -->
     <div id="edit-win" class="easyui-dialog" title="非诉业务客户信息表" data-options="closed:true,iconCls:'icon-save',modal:true" style="width:400px;height:380px;">  
  	 ...
  	 <script type="text/javascript" src="<%=basePath%>/js/lawyer/base/ccase/page-noLitigationCustomer.js"></script>
  </body>
</html>
