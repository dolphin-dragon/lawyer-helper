  				...
  				title:'会议室基本信息表',
	   			...
	   			columns:[[
					...
					{field:'updated_time',title:'更新时间',align:'left',sortable:false,width:100,
						...
						*/
					{field:'mtr_name',title:'名称',align:'left',sortable:false,width:200,
							formatter:function(value,row,index){
								return row.mtrName;
							}
						},
					{field:'mtr_code',title:'编号',align:'left',sortable:false,width:80,
							formatter:function(value,row,index){
								return row.mtrCode;
							}
						},
					{field:'mtr_maxpersonnums',title:'最大容纳人数',align:'left',sortable:false,width:80,
							formatter:function(value,row,index){
								return row.mtrMaxpersonnums;
							}
						},
					{field:'mtr_description',title:'会议室使用说明',align:'left',sortable:false,width:260,
							formatter:function(value,row,index){
