...
/* 		width: 200px;
  ...
  <body class="easyui-layout">
     ...
     <!-- Edit Win&Form -->
     <div id="edit-win" class="easyui-dialog" title="Basic window" data-options="closed:true,iconCls:'icon-save',modal:true" style="width:500px;height:450px;visibility:hidden">  
  	 ...
  	 <!-- 审核窗口 -->
  	  <div id="sp-edit-win" class="easyui-dialog" title="案件审批" data-options="closed:true,iconCls:'icon-save',modal:true" style="width:500px;height:450px;visibility:hidden"> 
  	  		...
  	  		<div title="基本信息">
  	  		     <form id="base_Form" class="ui-form" method="post">  
		     		 ...
		     		 <div class="ui-edit hidden">
							<div class="fitem">
								<label>当事人</label>
								<input name="litigant" type="text" maxlength="128" class="easyui-validatebox" data-options="" missingMessage="请填写当事人"  style="margin: 0px; width: 300px;">
							</div>
							<div class="fitem">
								<label>被告名称</label>
							...
							<div class="fitem">
								<label>被告注册资本</label>
								<input name="defendantRegCapital" type="text" maxlength="32" class="easyui-validatebox" data-options="" missingMessage="请填写被告注册资本" style="margin: 0px; width: 300px;">
							</div>
							<div class="fitem">
								<label>被告所在地</label>
						...
						<!-- 	<div class="fitem">
							...
							<div class="fitem">
								<label>创建人</label>
								<!-- <input name="createdBy" type="text" maxlength="32" class="easyui-validatebox" data-options="" missingMessage="请填写创建人"> -->
								<input class="easyui-combobox" editable="false"  name="createdBy" data-options="valueField:'uid',textField:'name',url:'<%=basePath %>/sysUserExt/listDatas.do'" missingMessage="请填写创建人" style="margin: 0px; width: 300px;">
							</div>
							<div class="fitem">
								<label>创建时间</label>
							...
							<div class="fitem">
								<label>更新人</label>
								<!-- <input name="updatedBy" type="text" maxlength="32" class="easyui-validatebox" data-options="" missingMessage="请填写更新人"> -->
								<input class="easyui-combobox" editable="false"  name="updatedBy" data-options="valueField:'uid',textField:'name',url:'<%=basePath %>/sysUserExt/listDatas.do'" missingMessage="请填写更新人" style="margin: 0px; width: 300px;">
							</div>
						    <div class="fitem">
								<label>更新时间</label>
			...
			<div title="确立信息" >
				<form id="app_Form" class="ui-form" method="post">  
	     		  <input class="hidden" name="caseId">
					...
					<div class="fitem">
						<label>当事人</label>
						<input name="litigant" type="text" maxlength="128" class="easyui-validatebox" data-options="required:true" missingMessage="请填写当事人" missingMessage="请填写当事人" style="margin: 0px; width: 300px;">
					</div>
					<div class="fitem">
						<label>被告名称(全称)</label>
						<textarea name="defendantName" type="text" maxlength="1024" class="easyui-validatebox" placeholder="多被告换行分隔"  data-options="required:true" missingMessage="请填写被告名称" style="margin: 0px; width: 300px; height: 60px;"></textarea>
					...
					<div class="fitem">
						<label>案件来源</label>
						<select class="easyui-combobox" editable="false"  name="src" data-options="" missingMessage="请填写案件来源" style="margin: 0px; width: 300px;">
					...
					<div class="fitem">
						<label>是否公证</label>
						<select class="easyui-combobox" editable="false"  name="isApply" data-options="" missingMessage="请选择是否公证" style="margin: 0px; width: 300px;">
					...
					<div class="fitem">
						<label>公证书申请人</label>
						<input class="easyui-combobox" editable="false"  name="applicant" data-options="valueField:'uid',textField:'name',url:'<%=basePath %>/sysUserExt/listDatas.do'" missingMessage="请填写公证书申请人" style="margin: 0px; width: 300px;">
					</div>
					<div class="fitem">
						<label>取证人</label>
						<input class="easyui-combobox" editable="false"  name="forensics" data-options="valueField:'uid',textField:'name',url:'<%=basePath %>/sysUserExt/listDatas.do'" missingMessage="请填写取证人" style="margin: 0px; width: 300px;">
					</div>
					<div class="fitem">
						<label>侵权类型</label>
						<select class="easyui-combobox" editable="false"  name="violateType" id="violateType" data-options="" missingMessage="请填写侵权类型" style="margin: 0px; width: 300px;">
					...
					<div class="fitem">
						<label>侵权概况</label>
						<textarea name="violateDesc" type="text" maxlength="3072" placeholder="请填写线上侵权链接数量、图片数量及线下侵权图片数量、载体。" class="easyui-validatebox" data-options="" missingMessage="请填写侵权概况" style="margin: 0px; width: 300px; height: 60px;"></textarea>
					</div>
					<div class="fitem">
                    ...
                    <div class="fitem">
						...
						<select class="easyui-combobox" editable="false"  name="isDirectAction" data-options="" missingMessage="当事人是否要求直接诉讼" style="margin: 0px; width: 300px;">
                    		<option value="1">&ensp;&ensp;是&ensp;&ensp;</option>
                    		<option value="2" selected="selected">&ensp;&ensp;否&ensp;&ensp;</option>
                   		</select>
					</div>
			...
			<div title="二审信息">
			     <form id="second_Form" class="ui-form" method="post">  
		     		 ...
		     		 <div class="ui-edit hidden">
							...
							<div class="fitem">
								<label>二审主办律师</label>
								<input class="easyui-combobox" editable="false"  name="lawyer" data-options="valueField:'uid',textField:'name',url:'<%=basePath %>/sysUserExt/listDatas.do'" missingMessage="请填写二审主办律师" style="margin: 0px; width: 300px;">
							</div>
							<div class="fitem">
								<label>二审开庭日期</label>
								<input name="scourtDate" type="text" maxlength="10" class="easyui-datebox" data-options="" missingMessage="请填写二审开庭日期" style="margin: 0px; width: 300px;">
							</div>
							<div class="fitem">
								<label>主办法官</label>
								<input name="judge" type="text" maxlength="32" class="easyui-validatebox" data-options="" missingMessage="请填写主办法官" style="margin: 0px; width: 300px;">
							...
							<div class="fitem">
								...
								<input name="sjudgmentEffectiveDate" type="text" maxlength="32" class="easyui-datebox" data-options="" missingMessage="请填写二审判决生效日期" style="margin: 0px; width: 300px;">
							</div>
							<div class="fitem">
								<label>是否致歉</label>
								<select class="easyui-combobox" editable="false"  name="isApology" data-options="" missingMessage="请填写是否致歉" style="margin: 0px; width: 300px;">
							...
							<div class="fitem">
								...
								<input name="defendantCompensationTotal" type="text" maxlength="32" class="easyui-validatebox" data-options="" missingMessage="请填写一审被告赔偿总额" style="margin: 0px; width: 300px;">
							</div>
							<div class="fitem">
								<label>一审被告承担合理开支费用</label>
								<input name="defendantExpenses" type="text" maxlength="32" class="easyui-validatebox" data-options="" missingMessage="请填写一审被告承担合理开支费用" style="margin: 0px; width: 300px;">
							</div>
							<div class="fitem">
								<label>一审原告承担诉费</label>
								<input name="plaintiffCosts" type="text" maxlength="32" class="easyui-validatebox" data-options="" missingMessage="请填写一审原告承担诉费" style="margin: 0px; width: 300px;">
							</div>
							<div class="fitem">
								<label>一审被告承担诉费</label>
								<input name="defendantCosts" type="text" maxlength="34" class="easyui-numberbox" data-options="precision:2,groupSeparator:','" missingMessage="请填写一审被告承担诉费" style="margin: 0px; width: 300px;">
							</div>
							<div class="fitem">
								<label>是否结案</label>
								<select class="easyui-combobox" editable="false"  name="isClose" data-options="" missingMessage="请填写是否结案" style="margin: 0px; width: 300px;">
							...
							<div class="fitem">
								<label>执行截止日期</label>
								<input name="executionDeadline" type="text" maxlength="10" class="easyui-datebox" data-options="" missingMessage="请填写执行截止日期" style="margin: 0px; width: 300px;">
							</div>
							<div class="fitem">
								<label>是否需要执行</label>
								<select class="easyui-combobox" editable="false"  name="isCarryOut" data-options="" missingMessage="是否需要执行" style="margin: 0px; width: 300px;">
		                    		<option value="1">&ensp;&ensp;是&ensp;&ensp;</option>
		                    		<option value="2" selected="selected">&ensp;&ensp;否&ensp;&ensp;</option>
		                   		</select>
							</div>
