...
<html>
  ...
  <body class="easyui-layout">
     ...
     <!-- Edit Win&Form -->
     <div id="edit-win" class="easyui-dialog" title="仲裁案件信息表" data-options="closed:true,iconCls:'icon-save',modal:true" style="width:400px;height:380px;">  
     	<form id="editForm" class="ui-form" method="post">  
     		 ...
     		 <div class="ui-edit">
		     	  <!--  <div class="ftitle">仲裁案件信息表</div>
					...
					<div class="fitem">
						<label>案由</label>
						<textarea name="cause" type="text" maxlength="3072" class="easyui-validatebox" data-options="" missingMessage="请填写案由" style="margin: 0px; width: 200px; height: 100px;"></textarea>
					</div>
					<div class="fitem">
						<label>申请人</label>
						<input name="applicant" type="text" maxlength="32" class="easyui-validatebox" data-options="" missingMessage="请填写申请人">
					</div>
					<div class="fitem">
						<label>被申请人</label>
						<input name="respondent" type="text" maxlength="32" class="easyui-validatebox" data-options="" missingMessage="请填写被申请人">
					</div>
					<div class="fitem">
						<label>反请求状况</label>
						<input name="request" type="text" maxlength="32" class="easyui-validatebox" data-options="" missingMessage="请填写反请求状况">
					</div>
					<div class="fitem">
						<label>委托协议日期</label>
						<input name="trustDate" type="text" maxlength="10" class="easyui-datebox" data-options="" missingMessage="请填写委托协议日期">
					</div>
					<div class="fitem">
						<label>主办律师</label>
					...
					<div class="fitem">
						<label>出庭代理人</label>
						<input name="agent" type="text" maxlength="32" class="easyui-validatebox" data-options="" missingMessage="请填写出庭代理人">
					</div>
					<div class="fitem">
						<label>首席仲裁员</label>
						<input name="chiefArbitrator" type="text" maxlength="32" class="easyui-validatebox" data-options="" missingMessage="请填写首席仲裁员">
					</div>
					<div class="fitem">
						<label>我方边裁</label>
						<input name="ourSide" type="text" maxlength="32" class="easyui-validatebox" data-options="" missingMessage="请填写我方边裁">
					</div>
					<div class="fitem">
						<label>对方边裁</label>
						<input name="otherSide" type="text" maxlength="32" class="easyui-validatebox" data-options="" missingMessage="请填写对方边裁">
					</div>
					<div class="fitem">
						<label>仲裁秘书</label>
						<input name="arbSecretary" type="text" maxlength="32" class="easyui-validatebox" data-options="" missingMessage="请填写仲裁秘书">
					</div>
					<div class="fitem">
						<label>仲裁秘书联系方式</label>
						<input name="secretaryContact" type="text" maxlength="32" class="easyui-validatebox" data-options="" missingMessage="请填写仲裁秘书联系方式">
					</div>
					<div class="fitem">
						<label>开庭次数</label>
						<input name="opCourtNums" type="text" maxlength="32" class="easyui-validatebox" data-options="" missingMessage="请填写开庭次数">
					</div>
					<div class="fitem">
						<label>开庭日期</label>
						<input name="opCourtDate" type="text" maxlength="10" class="easyui-datebox" data-options="" missingMessage="请填写开庭日期">
					</div>
					<div class="fitem">
						<label>结案方式</label>
						<input name="closType" type="text" maxlength="32" class="easyui-validatebox" data-options="" missingMessage="请填写结案方式">
					</div>
  			</div>
     	</form>
  	 </div>
  	 <script type="text/javascript" src="<%=basePath%>/js/lawyer/base/ccase/page-arbitrationCase.js"></script>
  </body>
</html>
