...
<!-- 		     	   <div class="ftitle">用户信息设置</div>
					...
					<div class="fitem">
						...
						<select class="easyui-combobox" editable="false"  name="sex" data-options="" missingMessage="请填写性别">
					...
					<div class="fitem">
						...
						<select class="easyui-combobox" editable="false"  name="position" data-options="required:true" missingMessage="请填写职位类别">
